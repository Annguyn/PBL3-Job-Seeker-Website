...
def extract_salary(text):
    patterns = [
    # r'(?P<min_salary>\d{2}(?:\.\d{3})?)\s*-\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*m',
    # r'\b(?:up\s*to|upto)?\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*tr',
    # r'(?P<min_salary>\d{2}(?:\.\d{3})?)\s*triệu\s*-\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*triệu',
    # r'\b(?P<min_salary>\d{2})\s*million\s*-\s*(?P<max_salary>\d{2})\s*million\b',
    # r'\b(?P<min_salary>\d{2})\s*m\s*-\s*(?P<max_salary>\d{2})\s*m\b',
    # r'\b(?P<min_salary>\d{2})\s*triệu\s*-\s*(?P<max_salary>\d{1,2})\s*triệu\b',
    ...
    # r'(?P<min_salary>\d{2}(?:\.\d{3})?)\s*-\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*vnd',
    # r'\b(?P<min_salary>\d{2})\s*triệu\s*đến\s*(?P<max_salary>\d{2})\s*triệu\b',
    # r'(?P<min_salary>\d{2}(?:\.\d{3})?)\s*vnd\s*-\s*(?P<max_salary>\d{2}(?:\.\d{3})?)vnd',
    ...
    # r'(?:up\s*to)?\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*m',
    # r'\$(?P<min_salary>\d{2}(?:\.\d{3})?)\s*-\s*\$(?P<max_salary>\d{2}(?:\.\d{3})?)',
    # r'(?P<min_salary>\d{2}(?:\.\d{3})?)\$\s*-\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\$',
    # r'(?P<min_salary>\d{2}(?:\.\d{3})?)\s*-\s*\$(?P<max_salary>\d{2}(?:\.\d{3})?)',
    # r'\$(?P<min_salary>\d{2}(?:\.\d{3})?)\s*-\s*(?P<max_salary>\d{2}(?:\.\d{3})?)',
    # r'(?P<min_salary>\d{2}(?:\.\d{3})?)\s*usd\s*-\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*usd',
    # r'(?P<min_salary>\d{3,4})\s*-\s*(?P<max_salary>\d{3,4})\s*usd',
    # r'(?P<min_salary>\d{3,4})\s*USD\s*-\s*(?P<max_salary>\d{3,4})\s*usd',
    # r'(?:\bup\s*to|\bupto)\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*tr',
    # r'(?:\bup\s*to|\bupto)\s*(?P<max_salary>\d{2}(?:\.\d{3})?)\s*triệu',
    # r'(?:\bup\s*to|\bupto)\s*(?P<max_salary>\d{3,4}(?:\.\d{3})?)\s*usd',
