    ...
    experience TEXT
      ...
      INSERT INTO db_website.recruitment_post (
           ...
           'null', 50000000, 5000000, 'Unknown', 'talina.hr13@gmail.com',
            'TOPJOBTUYỂN DỤNG BACKEND DEVELOPER NODEJS HNn Range lương upto 50 triệu có thể thỏa thuận theo năng lựcn Có từ 5 năm kinh nghiệm sử dụng Nodejs  làm việc với các dự án blockchain n Có kiến thức và kinh nghiệm phát triển hệ thống cơ sở dữ liệu SQL và NoSQLn Có kinh nghiệm về mạng bảo mật xác thực HTTP Basic OAuth  bảo mật và dữ liệu GDPR mã hóa dữ liệun Làm việc tại Cầu Giấy HNnGửi CV qua mail talinahr13gmailcom', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 26000000, 2000000, 'Unknown', 'trinhphp@kalapa.vn',
            'Nam Từ Liêm  Hà Nội KALAPA tuyển DATA ENGINEER  2 NĂM KINH NGHIỆM  UPTO 26MILnYêu cầun  2 năm kinh nghiệm DEn Kiến thức về lập trình cấu trúc dữ liệu  giải thuậtn Kiến thức về xây dựng luồng xử lý dữ liệu batch processing stream procesingn Kiến thức về các loại CSDL RDBMS Graph Databases NoSQL Productsn Kỹ năng sử dụng một trong các ngôn ngữ lập trình Java Python SQLnJD chi tiết httpswwwlinkedincomjobsview3840144964nFlex phúc lợi sương sươngnThu nhập cạnh tranh up to 26mil nThưởng quý thưởng KPInBảo hiểm PVI cho nhân viên và người thânnĂn sáng trưa xế không lo nghĩ chỉ cần tập trung làm việc và đi du lịch 3 kỳnămnnĐịa điểm làm việc Tòa Ecolife số 58 Tố Hữu Phường Mễ Trì Quận Nam Từ Liêm Hà NộinThời gian làm việc 800 AM  500 PM T2  T6nCV ứng tuyển gửi về mail trinhphpkalapavn', '[]', '2'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 20000000, 17000000, '0968 805 725', 'lethu.worklink@gmail.com',
            'IT DEVELOPERn3 năm kinh nghiệm  Mức lương 17  20 mil grossnLàm việc tại KCN Long Đức  Đồng Nai Có xe đưa đón từ HCM Biên HòanLập trình phát triển các chức năng hệ thống QLSXnQuản lý CSDLnfrontend frontenddeveloper C SQL javascript phpdeveloper MVCnnGửi CV về mail để được hỗ trợ job phù hợp nhấtn lethuworklinkgmailcomn SĐTZalo 0968 805 725 Thư', '[]', '3'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 16000000, 1000000, '077.544.2130', 'tuyendung2.worklink@gmail.com',
            ' Đồng Nai TUYỂN DỤNG VỊ TRÍ IT SOFTWAREnĐịa điểm  KCN Long Đức  Đồng NainnLƯƠNG TỪ  15 16TRn NamNữ tuổi từ 21 28n Tốt nghiệp CĐĐH chuyên ngành Khoa học máy tính Tin học ứng dụngCông nghệ phần mềmn Ít nhất 1 năm kinh nghiệm phát triển phần mềm thực tến Kiến thức C Windows Form vững chắcn Thành thạo HTML CSS JavaScriptn Có kiến thức về Ruby WebAPI xamarin là lợi thếnnCV ứng tuyển gửi về email với tiêu đề  TÊN  VỊ TRÍ ỨNG TUYỂN  ĐỊA ĐIỂM nMail tuyendung2worklinkgmailcomnZalo 0775442130', '[]', '1'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 25000000, 2000000, '9674185330', 'Mai.hoang@hrchannels.com',
            'Yên Phong BNinh  HRCHANNELS TÌM KIẾM LẬP TRÌNH SOFTWARE 1525tr Grossn ĐỊA ĐIỂM Yên Trung Yên Phong Bắc Ninhn YÊU CẦUn2 năm kinh nghiệm lập trình Software thành thạo CCnKinh nghiệm làm việc với SQL Server MySQLPostgresqlnMÔ TẢ CÔNG VIỆC Vận hành sửa chữa nâng cấp chương trình cho máy testnnỨng viên quan tâm vui lòng liên hệ qua IB  09674185330  hoặc gửi CV qua email Maihoanghrchannelscom', '[]', '2'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 15000000, 1000000, '0899 144 689', 'ndienntm@coway.com.vn',
            'Công ty Cổ phần Thương mại Carpa Việt Nam cần tuyển 1 Fullstack DevelopernYêu cầun Biết lập trình web sử dụng tốt JS và jquery Bắt buộcn Có kinh nghiệm về ERP hoặc CRM Bắt buộcn Biết clean code và tối ưu hóa hiệu suấtn Có kinh nghiệm về Java hoặc Nodejs tối thiểu 1 nămnMức lương 15 triệunĐịa chỉ 27B Nguyễn Đình Chiểu Đa Kao Quận 1 HCMnỨng tuyển Gửi CV qua emailndienntmcowaycomvnn0899 144 689 zalo', '[]', '1'        
        );
...
2 Nhà phát triển Phần mềm   60 triệu tổng  Nhà phát triển Full Stack hơn 5 năm  Python JavascriptTypescript NodeJS  trải nghiệm với AWSn3 Nhà phát triển FullStack Cao cấp Angular  Python   5 tuổi 65 triệu tổngn4 Nhà phát triển cấp cao Fullstack C  Angular   5 tuổi 65 triệu grossn5 Nhà phát triển Frontend cao  60 triệu tổng  5 năm kinh nghiệm  Kinh nghiệm dày dặn trong việc phát triển môđun Angularn6 Kỹ sư DevOps   65 triệu tổng  3 năm với Scrum và với tư cách là DevOpsn7 Kỹ sư Đảm bảo Chất lượng   55 triệu tổng  Hơn 4 năm kinh nghiệm kiểm tra hệ thống backend ứng dụng webn Lợi íchn Bảo hiểm y tế tư nhân bao gồm các gói dành cho các thành viên gia đìnhn Thanh toán trọn gói BHXH theo lương chính thức của bạnn Full lương thứ 13  thưởng dao độngn 15 ngày nghỉ  10 lá bệnhn Chính sách Văn phòng Đặc biệtn Chuyến đi công tyn Quà tặng trong các sự kiện đặc biệtn Liên kết nhóm hàng thángn Cung cấp laptop 2 màn hìnhn Ghế Ergonomicnhiring open fullstack hybrid remote IT java angular devops mobile QAnnLiên hệ với tôi để biết thêm thông tinnEmail Duyennguyenviecoigmailcom Ms DuyennĐiện thoại 84 287 3030 707  Ext 1024nZalo 085 69 38 576nSkype trực tiếp Cid a7f8289a10e2fbf0nĐược dịch từ Tiếng Anh', '[]', '5'
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 46000000, 4000000, '906716238', 'thu.vo@reeracoen.com.vn',
            'FRONT END  BACK ENDnAutomation software devnLương up 46 Mil grossnĐịa điểm Bắc Ninh xe đưa rước từ Hà NộinnYÊU CẦUn Tốt nghiệp Đại học ngành ITn 5 năm Kn appliation và web serveruser interface và user experiencen Skills Java Cn Tiếng Anh intermediate levelnnZalo 0906716238nEmail thuvoreeracoencomvn', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 25000000, 2000000, '981447103', 'jennie.ly.chu@hrchannels.com',
            'BẮC NINH HRCHANNELS TUYỂN DỤNG NHÂN VIÊN LẬP TRÌNH SOFTWARE  25 TRIỆUn ĐỊA ĐIỂM Yên Phong Bắc Ninhn YÊU CẦU 2 năm kinh nghiệm lập trình Software  thành thạo C CnnỨng viên quan tâm vui lòng liên hệ qua IB  Zalo 0981447103 hoặc gửi CV qua email jennielychuhrchannelscom', '[]', '2'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 5000000, 0, 'Unknown', 'hr.vietnam@arbin.com',
            'DI AN BINH DUONG sát THU DUC HCMC nCTY ARBIN INSTRUMENTS VIET NAMncần tuyển các vị trí sau nSALARY 1000  2000n1 Middle FrontEnd Developer React Angular n1 Senior Software Testing Engineer C MySQL QA n1 Senior Java Backend Developer J2EE SQL Linux n1 Senior C BackEnd Developer C SQL  aspnet n1 Senior Fullstack Developer J2EE Java Angular nnYêu cầu kinh nghiệm từ 3 năm tốt nghiệp Đại học tiếng Anh khá giỏi Xin vui lòng gửi CV về  hrvietnamarbincom', '[]', '3'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 46000000, 4000000, '906716238', 'thu.vo@reeracoen.com.vn',
            'FRONT END  BACK ENDnAutomation software devnLương up 46 Mil grossnĐịa điểm Bắc Ninh xe đưa rước từ Hà NộinnYÊU CẦUn Tốt nghiệp Đại học ngành ITn 5 năm Kn appliation và web serveruser interface và user experience   Skills Java Cn Tiếng Anh intermediate levelnnZalo 0906716238nEmail thuvoreeracoencomvn', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 13000000, 1000000, '0339 588 926 ', 'my.nguyen@shr.com.vn',
            'Long Thành ĐỒNG NAI SHR VN  Đối tác là DN sản xuất của Nhật cần tuyển các vị trínNHÂN VIÊN IT Lập trình viên 1113trn Yêu cầun Ứng viên NamNữ 2224 tuổin Tốt nghiệp Đại học ngành CNTTĐiện tử viễn thôngn Am hiểu C Java C Python Ngôn ngữ lập trình Webn Có kinh nghiệm quản lý dữ liệu sản xuất của công ty 13 nămn Tiếng Anh giao tiếp và báo cáo Ưu tiên biết thêm Tiếng Nhậtn Quyền lợin Có xe đưa đónn 13 tháng lương  thưởng 2 lầnnăm mỗi lần khoảng 1 tháng lương  lớp học tiếng Nhật tại công tynnỨng viên quan tâm vui lòng nhắn tin zalo 0339 588 926 để nhận JD chi tiết gửi CV về mail mynguyenshrcomvn', '[]', '3'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 1000000, 0, 'Unknown', 'vi.phan@adecco.com',
            'Q7HCM Grab Vietnam đang chờ đợi bạn Senior Backend và Middle Fullstack Developernn1 YÊU CẦUn Có từ 3 năm kinh nghiệm FullstackBackend GO preferedn Mạnh về algorithms và data structuresn Tiếng Anh tốt làm việc với Regionn Khả năng giao tiếp và làm việc nhóm tốtn2 MỨC LƯƠNGnMức lương Upto 101Mn WFH 2 ngàytuầnnĐể biết thêm chi tiết vui lòng ib cho mình hoặc apply CV qua viphanadeccocom', '[]', '3'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 50000000, 5000000, '0914.779.655', 'hr@emso.vn',
            'TUYỂN DỤNG TRƯỞNG NHÓM PHP  LẬP TRÌNH VIÊN REACTJSnCông ty cổ phần EMSO Việt Nam cần tuyển dụngn02 PHP  2 năm Kinh nghiệm Đã từng làm Reactjs biết drupaln02 Reactjs  1 năm Kinh nghiệm ưu tiên có kinh nghiệm xử lý Performance WebnỨng viên nộp CV qua mail vui lòng ghi rõ Apply Trưởng nhóm PHP hoặc LTV ReastjsnLưu ý EMSO có bước lọc và loại CV trước khi gọi PV và chỉ liên hệ đặt lịch phỏng vẫn những CV đạt yêu cầunYêu cầu trong công việcn Trẻ trung đam mê khám phá và sẵn sàng với mọi thử thách mớin Thời gian làm việc Thứ 2  sáng T7 hàng tuầnnSáng 8h3012h  Chiều 14h18h00 75hngàynHồ sơ xin việc vui lòng gửi vền Email hremsovnn Hotline 0914779655Mrs Hiềnn Địa chỉ Toà A2 Thăng Long Garden 250 Minh Khai Hai Bà Trưng Hà Nội', '[]', '2'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 50000000, 5000000, 'Unknown', 'hr@emso.vn',
            '250 Minh Khai  HN CÔNG TY CỔ PHẦN EMSO VIỆT NAMnTUYỂN DỤNG LẬP TRÌNH VIÊNTHỰC TẬP SINHnMức lương thỏa thuậnnCác ngôn ngữn Thực tập sinh sinh React JS Node Js Ruby PHP Pythonn Lập trình viên React JS  Kinh nghiệm 1 năm ưu tiên có kinh nghiệm xử lý Performance Webn Lập trình viên Flutter  Kinh nghiệm 2 năm có kinh nghiệm xử lý VideonCông việc Làm việc với team Product Design để phát triển các tính năng phục vụ người dùngnYêu cầun Tốt nghiệp đại học hoặc đang là sinh viên đại học năm 4n Có kiến thức lập trình vị trí tương đươngn Có khả năng đọc hiểu tài liệu tiếng anh chuyên ngànhn Có kỹ năng làm việc nhóm tinh thần trách nhiệmnQuyền lợin Được hỗ trợ tùy theo năng lực khi tham gia vào dự ánn Được hưởng các chế độ phúc lợi theo quy địnhn Được làm việc trong môi trường trẻ trung năng động xét duyệt lương định kỳ 2 lầnnămnnThời gian làm việc T2 đến Sáng T7 8h30  12h00 và 14h00  18h00nCV ứng tuyển vui lòng gửi về email hremsovnnBạn nào quan tâm hãy ib mình hoặc để lại cmt bên dưới nhé', '[]', '1'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 17000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HCM Junior Middle STARFRUIT VINA tuyển dụng PHP Developer CodeIgniter Laravel  Offer 17tr25trn Yêu cầunCó tối thiểu 2 năm kinh nghiệm trong lĩnh vực phát triển web applicationnThành thạo ngôn ngữ lập trình PHP Laravel  CodeIgniter Framework Restful APInThành thạo sử dụng cơ sở dữ liệu MySQL  MariaDBn Đãi ngộnĐược đóng đầy đủ lương và bảo hiểm xã hội sau thử việcnQuà tặng sinh nhật đặc biệt và tiền thưởng ngày lễnTiền thưởng hiệu suất để đạt được mục tiêu vvnThời gian làm việcnCa cố định 8 tiếngngàynTuần làm việc 55 ngày  Chuyển sang tuần làm việc 5 ngày cho người lao động siêng năng sau 6 thángn Địa điểm làm việc 37 Đường số 2 Phường An Khánh Thành phố Thủ Đức Thành phố Hồ Chí MinhnnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  PHP Developer  STARFRUIT VINA', '[]', '2'
        );
...
ebsite httpszenscomn Ứng tuyển bằng cách gửi CV về emailn linhnxzenscomnVới tiêu đề email ứng tuyển CV_TÊN  VỊ TRÍ ỨNG TUYỂN', '[]', '1'        
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 15000000, 1000000, 'Unknown', 'info@ztech.asia',
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 17000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HCM Junior Middle STARFRUIT VINA tuyển dụng PHP Developer CodeIgniter Laravel  Lương 17tr25trn Yêu cầunCó tối thiểu 2 năm kinh nghiệm trong lĩnh vực phát triển web applicationnThành thạo ngôn ngữ lập trình PHP Laravel  CodeIgniter Framework Restful APInThành thạo sử dụng cơ sở dữ liệu MySQL  MariaDBn Đãi ngộnĐược đóng đầy đủ lương và bảo hiểm xã hội sau thử việcnQuà tặng sinh nhật đặc biệt và tiền thưởng ngày lễnTiền thưởng hiệu suất để đạt được mục tiêu vvn Thời gian làm việcnCa cố định 8 tiếngngàynTuần làm việc 55 ngày  Chuyển sang tuần làm việc 5 ngày cho người lao động siêng năng sau 6 thángn Địa điểm làm việc 37 Đường số 2 Phường An Khánh Thành phố Thủ Đức Thành phố Hồ Chí MinhnnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  PHP Developer  STARFRUIT VINA', '[]', '2'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 2000000, 0, 'Unknown', 'career@topdev.vn',
            'Q7HCM Alephon tuyển dụng Software Engineer Analyst CJavaScript or CC SQL  Offer 6001000n Yêu cầun2 năm kinh nghiệm về ít nhất một trong các ngôn ngữ lập trình sau C JavaScript hoặc CCn2 năm kinh nghiệm về SQLnTiếng Anh tốt nói  viếtnĐãi ngộnĐược đảm bảo lương tháng 13nReview lương 2 lầnnămnCung cấp đầy đủ trang thiết bịn Thời gian làm việc Thứ 2  Thứ 6 8h3017h30n Địa điểm làm việc Office 906 Paragon Building 3 Nguyễn Lương Bằng Phường Tân Phú Quận 7 Thành phố Hồ Chí MinhnnGửi CV tiếng Anh về careertopdevvnnTiêu đề Mail  Họ tên  Software Engineer Analyst  Alephon', '[]', '2'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 20000000, 2000000, '962376506', 'thu.hipvietnam@gmail.com',
            'KCN Thăng Long1  HÀ NỘI Công ty sản xuất của NhậtnTUYỂN NHÂN VIÊN ITnLương 15 20TRnMÔ TẢ CÔNG VIỆCn Quản trị phòng server cập nhật phiên bản window thiết bị backup dữ liệu servern Quản trị mạng máy tính lắp đặt di dời sửa chữa máy tính toàn công tyn Quản trị cơ sở dữ liệu web xin phép onlinewebsite bao gồm cập nhật và update dữ liệu nếu cón Quản trị hệ thống camera phần mềm trạm cânn Lắp đặt di dời sửa chữa camera đường dây điện thoạin Quản lý License win server License win 10 và License Kaperskyn Các công việc khác do cấp trên giao phónYÊU CẦUn Nam tốt nghiệp Cao Đẳng trở lên nghành công nghệ thông tinn 23 năm kinh nghiệm vị trí tương đươngn Biết lập trình phần mềm ngôn ngữ lập trình C CSS HTML javascript ajaxnLH thuhipvietnamgmailcomnZalo 0962376506', '[]', '3'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HN MOBIFONE PLUS tuyển dụng Trưởng Phòng Lập Trình  Lương 18tr30trn Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUS', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'Hà Nội MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  Lương 18tr30trn Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUS', '[]', '5'    
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 15000000, 1000000, 'Unknown', 'career@topdev.vn',
            'Hà Nội DTN SOFTWARE SOLUTIONS tuyển dụng Java Developer  Lương 15tr25trn Yêu cầunCó từ 2 năm kinh nghiệm làm việc với Java trở lênnThành thạo các framework java như Spring Struts là 1 lợi thếnCó kinh nghiệm làm việc với các công cụ hỗ trợ phát triển phần mềm như Git Jiran Đãi ngộnThưởng theo dự án lên tới 3 tháng lương mỗi năm và thưởng tháng thứ 13nXét tăng lương hàng nămnĐược đóng bảo hiểm theo quy định của Luật lao độngnHỗ trợ ăn trưa gửi xe miễn phín Thời gian làm việc Từ thứ 2 đến thứ 6 Sáng 9h0011h45 Chiều 13h0018h00n Địa điểm làm việc B12B02 khu đô thị Vinhomes Gardenia đường Hàm Nghi Phường Cầu Diễn Quận Nam Từ Liêm Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Java Developer  DTN', '[]', '2'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HN MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  18tr30trn Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUSnLink JD httpstopdevvnssG276KUO', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HN MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  18tr30trn Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏenĐịa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUSnLink JD httpstopdevvnssG276KUO', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'Hà Nội MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  18tr30trn Yêu cầunCó ít nhất 5 năm kinh nghiệm lập trình trong đó có ít nhất 1 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUSnLink JD httpstopdevvns8Wr42OGJ', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HN MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  18Mil30Miln Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUSnLink JD httpstopdevvns8Wr42OGJ', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HN MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  Range Lương 18tr30trn Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUSnLink JD httpstopdevvnsnPnGG45z', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 80000000, 8000000, '035 30 69 077', 'minhthunguyen.viecoi@gmail.com',
            ' HYBRID HCM CHÚNG TÔI ĐANG TÌM KIẾM KỸ SƯ RUBY TRÊN RAILS  LÊN ĐẾN 80M GROSS  nMô tả công việcn Thiết kế và phát triển dịch vụ có thể làm một lượng dữ liệu lớnn Thiết kế cơ sở dữ liệu tốt xem xét các yêu cầu chức năng và không chức năngn Viết mã sạch và có thể duy trìn Cải thiện mã bằng cách phản ứng liên tụcn Giám sát hiệu suất ứng dụng và khắc phục lỗi hệ thốngn Đào tạo thành viên trẻgiữanYêu cầunPhải cón Từ 35 năm kinh nghiệm phát triển với Ruby on Railsn Hiểu tốt về các nguyên tắc CHẮC CHẮN các mẫu thiết kế thông dụng và cách làm tốt nhấtn Trải nghiệm vững chắc với MySQL hoặc PostgreSQL bao gồm điều chỉnh hiệu suất và tối ưu hóan Trải nghiệm với kiến trúc hệ thống phức tạp bao gồm liên kết API với hệ thống bên ngoàin Trải nghiệm với việc giám sát và tối ưu hóa hiệu suất ứng dụngn Trải nghiệm kiểm tra tự động hóa kiểm tra E2En Kiến thức sâu rộng về bảo mật webn Sự quen thuộc với CICD Dockern Tiếng Anh giao tiếpn Ý thức sở hữu mạnh mẽnTuyệtCóĐẹpn Trải nghiệm với Amazon Web Servicesn Trải nghiệm với vận hành dịch vụ về sản xuấtn Kinh nghiệm với phát triển friend TypeScript ReactJSVueJSnnLiên hệ với tôi để biết thêm thông tinnEmail minhthunguyenviecoigmailcom Ms ThunZalo 035 30 69 077nSkype trực tiếp Cid 9bbb59e064d9058anĐược dịch từ Tiếng Anh', '[]', '5'        
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 20000000, 2000000, 'Unknown', 'Hungcr1612@gmail.com',
            'CÔNG TY NHẬT TẠI KCN THĂNG LONG 1  ĐÔNG ANH GẦN ĐƯỜNG PHẠM VĂN ĐỒNG CÓ XE ĐƯA ĐÓN TỪ NỘI THÀNH HÀ NỘI CẦN TUYỂN NHÂN VIÊN ITnnYêu cầu công việcn Nam tốt nghiệp Cao Đẳng trở lên ngành công nghệ thông tinn 2  3 năm kinh nghiệm vị trí tương đươngn Biết lập trình phần mềm ngôn ngữ lập trình C CSS HTML javascript ajaxnnMô tả công việcn Quản trị phòng server cập nhật phiên bản windonw thiết bị backup dữ liệu servern Quản trị mạng máy tính lắp đặt di dời sửa chữa máy tính toàn công tyn Quản trị cơ sở dữ liệu web xin phép onlinewebsite bao gồm cập nhật và update dữ liệu nếu cón Quản trị hệ thống camera phần mềm trạm cânn Lắp đặt di dời sửa chữa camera đường dây điện thoạin Quản lý License win server License win 10 và License Kaperskyn Các công việc khác do cấp trên giao phónnLương 20 triệu grossnCV tiếng Việt gửi về mail Hungcr1612gmailcom', '[]', '3'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HN MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  18Mil30Miln Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUS', '[]', '5'
        );
        ...
        INSERT INTO db_website.recruitment_post (
           ...
           'null', 18000000, 1000000, 'Unknown', 'career@topdev.vn',
            'HN MOBIFONE PLUS  tuyển dụng Trưởng Phòng Lập Trình  18tr30trn Yêu cầunCó ít nhất 05 năm kinh nghiệm lập trình trong đó có ít nhất 01 năm ở vị trí trưởng nhómnCó kinh nghiệm triển khai backend API Restful kết nối và phục vụ trao đổi dữ liệu giữa các hệ thốngnCó kiển thức về Frontend HTML CSS Javan Đãi ngộnThu nhập tùy theo năng lực và kinh nghiệm 1718 tháng lươngnămnĐược hưởng các chế độ về BHXH BHYT BHTN và các chế độ khác theo quy định của Công tynĐóng bảo hiểm xã hội bảo hiểm sức khỏen Địa điểm làm việc Tầng 3A tòa nhà Harec số 4A Láng Hạ Phường Thành Công Quận Ba Đình Thành phố Hà NộinnGửi CV về careertopdevvnnTiêu đề Mail  Họ tên  Trưởng Phòng Lập Trình  MOBIFONE PLUS', '[]', '5'
        );
